...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.SelectMany(e => emps.Where(e => e.Mgr.HasValue)); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = from e1 in emps join e2 in emps on e1.Mgr equals e2.EmpNo
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = from emp in emps
            ...
            select new { EName = emp.EName, DName = dept.DName, Grade = grade.Grade };
